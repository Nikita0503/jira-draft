...
const UsersInProjectPicker = () => {
  ...
  const [usersInProject, setUsersInProject] = React.useState<IUser[]>(USERS_IN_PROJECT);
  const [usersOutsideProject, setUsersOutsideProject] = React.useState<IUser[]>(USERS_OUTSIDE_PROJECT);
  ...
  const removeUserFromProject = React.useCallback((selectedUser: IUser) => {
  ...
  return (
    <div className={styles.container}>
      ...
      <Button onClick={openModal} className={styles.button} variant="contained">Users In Project</Button>
    </div>)
  }
